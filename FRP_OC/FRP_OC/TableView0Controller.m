...
@interface TableView0Controller ()
/** 1. */
@property(nonatomic, strong)NSArray *arrayVC;
@end

@implementation TableView0Controller
...
- (NSArray *)arrayVC
{
    return @[@"RACSignalSubscriptionController", @"RACColdHot0Controller", @"RACColdHot2Controller", @"RACColdHot3Controller", @"RACColdHot4Controller"];
}
